...
function soall(){
	enginer="all";
	var site=getVByName();
	var url="<%=basePath%>so?engine=two&sotype=video";
	url=url+"&site="+site;
...
function sogoogle(){
	enginer="google";
	var site=getVByName();
	var url="<%=basePath%>so?engine=google&sotype=video";
	url=url+"&site="+site;
	var key2=$("input[name='keytext']").val();
	if(key2=="" || key2.length==0){
		return;
...
function sobaidu(){
	enginer="baidu";
	var site=getVByName();
	var url="<%=basePath%>so?engine=baidu&sotype=video";
	url=url+"&site="+site;
	var key2=$("input[name='keytext']").val();
	if(key2=="" || key2.length==0){
		return;
...
function onintchange(value){
	...
	<center>
		...
		<br/>
		<br/>
		<input type="radio" name="sun" value="baidu" checked="checked" onchange="onintchange(this.value)"/><img alt="百度影视" title="百度影视" src="img/baike/baidu.jpg"/>&nbsp;百度影视
		<input type="radio" name="sun" value="youku" onchange="onintchange(this.value)"/><img alt="优酷视频" title="优酷视频" src="img/video/youku.jpg"/>&nbsp;优酷视频
		<input type="radio" name="sun" value="tudou" onchange="onintchange(this.value)"/><img alt="土豆视频" title="土豆视频" src="img/video/tudou.jpg"/>&nbsp;土豆视频
		<input type="radio" name="sun" value="sohu" onchange="onintchange(this.value)"/><img alt="搜狐视频" title="搜狐视频" src="img/video/sohu.jpg"/>&nbsp;搜狐视频
		<input type="radio" name="sun" value="tengxun" onchange="onintchange(this.value)"/><img alt="腾讯视频" title="腾讯视频" src="img/video/tengxun.jpg"/>&nbsp;腾讯视频
		<input type="radio" name="sun" value="sina" onchange="onintchange(this.value)"/><img alt="新浪视频" title="新浪视频" src="img/video/sina.jpg"/>&nbsp;新浪视频
		<input type="radio" name="sun" value="aiqiyi" onchange="onintchange(this.value)"/><img alt="爱奇艺视频" title="爱奇艺视频" src="img/video/aiqiyi.jpg"/>&nbsp;爱奇艺视频
		<input type="radio" name="sun" value="pptv" onchange="onintchange(this.value)"/><img alt="pptv视频" title="pptv视频" src="img/video/pptv.jpg"/>&nbsp;pptv视频
		<input type="radio" name="sun" value="kankan" onchange="onintchange(this.value)"/><img alt="迅雷看看视频" title="迅雷看看视频" src="img/video/kankan.jpg"/>&nbsp;迅雷看看
		<input type="radio" name="sun" value="letv" onchange="onintchange(this.value)"/><img alt="乐视网" title="乐视网" src="img/video/letv.jpg"/>&nbsp;乐视网
		<input type="radio" name="sun" value="pps" onchange="onintchange(this.value)"/><img alt="PPS" title="PPS" src="img/video/pps.jpg"/>&nbsp;PPS
		<input type="radio" name="sun" value="fun" onchange="onintchange(this.value)"/><img alt="风行" title="风行" src="img/video/fun.jpg"/>&nbsp;风行
	...
	if(first=="true"){
		...
		if(key2.length>0){
			...
			url=url+"&sotype=video&site=baidu";
			$.post(url,{key:key2},function(data){
		    	//alert(data);
				var url =data.split("~");
				//alert(url[0]);
