...
function soall(){
	enginer="all";
	var site=getVByName();
	var url="<%=basePath%>so?engine=two&sotype=blog";
	url=url+"&site="+site;
...
function sogoogle(){
	enginer="google";
	var site=getVByName();
	var url="<%=basePath%>so?engine=google&sotype=blog";
	url=url+"&site="+site;
	var key2=$("input[name='keytext']").val();
	if(key2=="" || key2.length==0){
		return;
...
function sobaidu(){
	enginer="baidu";
	var site=getVByName();
	var url="<%=basePath%>so?engine=baidu&sotype=blog";
	url=url+"&site="+site;
	var key2=$("input[name='keytext']").val();
	if(key2=="" || key2.length==0){
		return;
...
function onselchange(value){
	...
	<center>
		...
		<br/>
		<br/>
		<input type="radio" name="sun" value="csdn" checked="checked" onchange="onintchange(this.value)"/><img alt="csdn" title="csdn博客" src="img/csdn.jpg"/>&nbsp;csdn
		<input type="radio" name="sun" value="51cto" onchange="onintchange(this.value)"/><img alt="51cto" title="51cto博客" src="img/51cto.jpg"/>&nbsp;51cto
		<input type="radio" name="sun" value="itpub" onchange="onintchange(this.value)"/><img alt="itpub" title="itpub博客" src="img/itpub.jpg"/>&nbsp;itpub
		<input type="radio" name="sun" value="chinaunix" onchange="onintchange(this.value)"/><img alt="chinaunix" title="chinaunix博客" src="img/chinaunix.jpg"/>&nbsp;chinaunix
		<input type="radio" name="sun" value="iteye" onchange="onintchange(this.value)"/><img alt="iteye" title="iteye博客" src="img/iteye.jpg"/>&nbsp;iteye
		<input type="radio" name="sun" value="cnblogs" onchange="onintchange(this.value)"/><img alt="cnblogs" title="博客园" src="img/cnblogs.jpg"/>&nbsp;博客园
		<input type="radio" name="sun" value="sina" onchange="onintchange(this.value)"/><img alt="新浪博客" title="新浪博客" src="img/blog/sina.jpg"/>&nbsp;新浪博客
		<input type="radio" name="sun" value="sohu" onchange="onintchange(this.value)"/><img alt="搜狐博客" title="搜狐博客" src="img/blog/sohu.jpg"/>&nbsp;搜狐博客
		<input type="radio" name="sun" value="163" onchange="onintchange(this.value)"/><img alt="网易博客" title="网易博客" src="img/blog/163.jpg"/>&nbsp;网易博客
		<input type="radio" name="sun" value="tianya" onchange="onintchange(this.value)"/><img alt="天涯博客" title="天涯博客" src="img/blog/tianya.jpg"/>&nbsp;天涯博客
		<br/>
		<input type="radio" name="sun" value="tengxun" onchange="onintchange(this.value)"/><img alt="腾讯博客" title="腾讯博客" src="img/blog/tengxun.jpg"/>&nbsp;腾讯博客
		<input type="radio" name="sun" value="blogchina" onchange="onintchange(this.value)"/><img alt="博客中国" title="博客中国" src="img/blog/blogchina.jpg"/>&nbsp;博客中国
		<input type="radio" name="sun" value="hexun" onchange="onintchange(this.value)"/><img alt="和讯博客" title="和讯博客" src="img/blog/hexun.jpg"/>&nbsp;和讯博客
